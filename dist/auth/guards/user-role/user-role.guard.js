...
const rol_protected_decorator_1 = require("../../decorators/rol-protected/rol-protected.decorator");
let UserRoleGuard = class UserRoleGuard {
    ...
    canActivate(context) {
        const validRoles = this.reflector.get(rol_protected_decorator_1.META_ROLES, context.getHandler());
        if (!validRoles)
            return true;
        ...
        throw new common_1.ForbiddenException(`User ${user.fullName} need valid role ${validRoles}`);
    }
};
